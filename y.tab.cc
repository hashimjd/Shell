...
{
       0,    78,    78,    82,    83,    86,    90,    94,    95,    99,
     100,   105,   113,   114,   118,   185,   196,   197,   201,   209,
     219,   226,   232,   240,   252,   255
};
#endif
...
static const char *const yytname[] =
{
  ...
  "AMPERSAND", "GREATGREAT", "GREATAMPERSAND", "GREATGREATAMPERSAND",
  "LESS", "TWOGREAT", "PIPE", "$accept", "goal", "commands", "command",
...
{
       9,     7,    -6,    -6,     1,     8,    -6,    -6,     3,    -6,
      -6,    -6,    -6,    -6,    14,    -5,    15,    -6,    16,    -6,
      17,    18,    19,    20,    21,    -6,    22,    -6,    -6,    -6,
      -6,    -6,    -6,    -6,    -6,    -6
};
...
static const yytype_uint8 yydefact[] =
{
      ...
      13,     8,     1,     4,     0,    25,    11,     9,     0,    24,
       0,     0,     0,     0,     0,    16,     0,    14,    12,    18,
      21,    20,    22,    19,    23,     6
};
...
#line 118 "shell.y" /* yacc.c:1646  */
    ...
    int index_tilde = (yyvsp[0].cpp_string)->find('~', 0);
    int index_second_slash = (yyvsp[0].cpp_string)->find('/', 1);
    int index_b_slash = (yyvsp[0].cpp_string)->find('\\', 0);

    if ((strcmp((yyvsp[0].cpp_string)->data(), "~") == 0) || (strcmp((yyvsp[0].cpp_string)->data(), "~/") == 0)) {
      struct passwd *pw = getpwuid(getuid());
      const char *homedir = pw->pw_dir;
      free((yyvsp[0].cpp_string));
      ...
      for (int i = index_tilde + 1; i < (yyvsp[0].cpp_string)->size(); i++) {
        (*ans_str) += (yyvsp[0].cpp_string)->at(i);
      }
    ...
    if ((yyvsp[0].cpp_string)->at(0) == '/') {
        starts_with_slash = 1;
    }

    if (strcmp((yyvsp[0].cpp_string)->data(), "${?}") == 0) {
      Command::_currSimpleCommand->insertArgument((yyvsp[0].cpp_string));
    } else {
      expandWildcards(new std::string (""), (yyvsp[0].cpp_string));
    }
...
#line 219 "shell.y" /* yacc.c:1646  */
    ...
    std::string *str2 = new std::string((yyvsp[0].cpp_string)->c_str());
